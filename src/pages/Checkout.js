...
function Checkout() {
  ...
  const validateForm = () => {
    ...
    if (
      buyer.buyer_phone &&
      !/^(\+?254|0)[17]\d{8}$/.test(buyer.buyer_phone)
    ) {
    ...
    >
      <div className="row">
        <div className="col-lg-8">
          ...
          <div className="card border-0 shadow-sm mb-4" style={{ backgroundColor: 'rgba(255,255,255,0.9)' }}>
            <div className="card-body">
              <h3 className="mb-4" style={{ color: '#06D6A0' }}>
        ...
        <div className="col-lg-4">
          <div className="card border-0 shadow-sm sticky-top" style={{ top: '20px', backgroundColor: 'rgba(255,255,255,0.9)' }}>
            <div className="card-body">
